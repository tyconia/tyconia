...
#[require(Inventory)]
pub struct TransportInbound(Vec<ItemId>);
...
pub struct TransportDemand(pub Vec<(Entity, ItemId)>);

/// storage buffer of entity
#[derive(Component, Debug, Default)]
pub struct Inventory(pub Vec<(ItemId, usize)>);
